-- Rollback script for deletion batch: 20250702_111001
-- Generated on: 2025-07-02T11:10:01.457084
-- 
-- INSTRUCTIONS:
-- 1. Review the records in the backup tables first:
--    SELECT * FROM account.virtual_account_holder_deletion_backup_20250702_111001 ORDER BY person_id;
--    SELECT * FROM entity.entity_deletion_backup_20250702_111001 ORDER BY entity_id;
...
FROM account.virtual_account_holder_deletion_backup_20250702_111001
...
FROM entity.entity_deletion_backup_20250702_111001
...
-- JOIN account.virtual_account_holder_deletion_backup_20250702_111001 b ON v.person_id = b.person_id;
-- SELECT COUNT(*) as restored_entity_count FROM entity.entity e
-- JOIN entity.entity_deletion_backup_20250702_111001 b ON e.entity_id = b.entity_id;

-- After successful restore, clean up backup tables
-- DROP TABLE account.virtual_account_holder_deletion_backup_20250702_111001;
-- DROP TABLE entity.entity_deletion_backup_20250702_111001;
